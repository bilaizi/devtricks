...
public class BundleSerializer<T extends Serializable> {
    ...
    public BundleSerializer() {bundleProperty = DEFAULT_BUNDLE_PROPERTY;}
    public BundleSerializer(final String bundle_property) {this.bundleProperty = bundle_property;}
