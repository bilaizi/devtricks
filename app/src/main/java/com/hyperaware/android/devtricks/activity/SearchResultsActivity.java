...
public class SearchResultsActivity extends AppCompatActivity {
    ...
    private void restoreState(final Bundle bundle) {
        if (bundle != null) {
            BundleSerializer<State> serializer = new BundleSerializer<>();
    ...
    private void initViews() {
        ...
        findViewById(R.id.button_sort_ascending).setOnClickListener(v-> sortAscending());
        findViewById(R.id.button_sort_descending).setOnClickListener(v-> sortDescending());
    }
    ...
    private class SearchResultsAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public SearchResultsAdapter(List<Item> items) {this.items = items;}
        @Override
